...
public final class PdfBoxHelper {
     ...
     */
    public static float addText(PDPageContentStream stream, PdfReportTextConfig textConfig, float textX, float textY, float allowedWidth, float lineHeightD, ReportAlignType align, String text) {
     ...
     * @param text       text
     */
    public static void addTextSimple(PDPageContentStream stream, PdfReportTextConfig textConfig, float textX, float textY, String text) {
        try {
